...
.submit{
  ...
  <div class="container">
        <a href="ajout.php" classe="btn_aj"  style="color:green;"><img src="image/ajouter.png" alt="">Ajouter</a>
              ...
              // inclure la page de connexion 
               ...
               //requete pour afficher la liste des employés 
                ...
                while($row=mysqli_fetch_assoc($req)){
                   ...
                   <td><a href="modifier.php?id=<?=$row['id']?>"><img src="image/crayon.png"></a></td>
                        <td><a href="supprimer.php?id=<?=$row['id']?>"><img src="image/effacer.png"></a></td>
                      </tr>
